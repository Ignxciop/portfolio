...
const PROJECTS = [
    ...
    {
        name: "Mining Game",
        image: "/mining-game.png",
        url: "https://mining.josenunez.cl/",
        description:
            "Incremental/idle mining game construido con Phaser 4 + React 19 + TypeScript. Sesiones de 20s con minería automática por proximidad, 25 minerales con sprites evolutivos, árbol de habilidades con ~49 nodos, sistema de prestigio, eventos raros durante la partida y despliegue Docker con Cloudflare Tunnel. Diseñado como PWA con soporte mobile y desktop.",
    },
];
    ...
    return (
        <div className="min-h-dvh bg-slate-950 flex items-center justify-center md:p-4">
            <div className="w-full max-w-6xl bg-slate-900 md:rounded-2xl shadow-2xl flex flex-col md:flex-row md:max-h-[calc(100dvh-2rem)]">
                <aside className="md:w-80 p-10 md:p-12 flex flex-col justify-between border-slate-800 border-b md:border-b-0 md:border-r max-md:gap-8">
                    <div>
                        ...
                        <p className="text-slate-400">
                            Transformo ideas en aplicaciones web
                        </p>
                ...
                <main
                    id="right-column"
                    className="flex-1 md:overflow-y-auto p-10 md:p-12"
                >
                    <div className="max-w-2xl mx-auto space-y-24 max-md:space-y-16">
                        <section id="about" className="scroll-mt-8">
                            ...
                            <div className="space-y-4 text-slate-400 leading-relaxed text-[15px]">
                                <p>
                                    Soy desarrollador Full-Stack con más de dos
                                    años de experiencia trabajando en el
                                    desarrollo de aplicaciones web y soluciones
                                    internas orientadas a mejorar procesos y
                                    facilitar la toma de decisiones. A lo largo
                                    de este tiempo he participado en proyectos
                                    donde el foco ha sido crear herramientas
                                    útiles, claras y alineadas a las necesidades
                                    reales de los usuarios.
                                </p>
                                <p>
                                    He trabajado desarrollando soluciones
                                    full-stack utilizando tecnologías como
                                    React, Node.js y Next.js, integrando APIs,
                                    automatizaciones y bases de datos
                                    relacionales. Gran parte de mi experiencia
                                    se ha dado en proyectos donde la
                                    organización de la información, la
                                    automatización de flujos y la optimización
                                    de procesos han sido clave.
                                </p>
                                <p>
                                    Me interesa especialmente el desarrollo de
                                    productos que tengan un impacto directo en
                                    las personas que los usan. Disfruto pensar
                                    la lógica del producto, entender el problema
                                    antes de escribir código y buscar soluciones
                                    simples que se mantengan en el tiempo.
                                </p>
                                <p>
                                    Me considero una persona autodidacta,
                                    adaptable y con atención al detalle, que
                                    valora el trabajo en equipo y la
                                    comunicación clara. Siempre estoy
                                    aprendiendo nuevas herramientas y buenas
                                    prácticas para seguir mejorando tanto a
                        ...
                        <section id="experience" className="scroll-mt-8">
                            ...
                            <div className="space-y-8">
                                {EXPERIENCES.map((exp) => (
                                    <div
                                        key={exp.company}
                                        className="flex gap-5 max-md:flex-col max-md:gap-1"
                                    >
